...
```bash
sudo microk8s helm install --dry-run hyperdos hyperdos/hyperdos --version 0.1.1 --set token="DRY_RUN_NO_TOKEN"
```
...
sudo microk8s helm install hyperdos hyperdos/hyperdos --version 0.1.1 --set token="<YOUR_API_KEY>"
```
